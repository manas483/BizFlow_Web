...
const RevenueTrendChart = dynamic(() => import("@/shared/ui/widgets/ReportsCharts").then(m => m.RevenueTrendChart), { ssr: false });
const ProfitComparisonChart = dynamic(() => import("@/shared/ui/widgets/ReportsCharts").then(m => m.ProfitComparisonChart), { ssr: false });
const BreakdownPieChart = dynamic(() => import("@/shared/ui/widgets/ReportsCharts").then(m => m.BreakdownPieChart), { ssr: false });
import { PriceAuditTrail } from "@/shared/ui/reports/PriceAuditTrail";

// Tooltip moved to ReportsCharts.tsx
            ...
            <Card className="shadow-sm border-primary/10">
              ...
              <CardContent>
                {expensesByCategory.length === 0 ? (
                  ...
                  <>
                    <BreakdownPieChart data={expensesByCategory} />
            ...
            <Card className="shadow-sm border-primary/10">
              ...
              <CardContent>
                {salesByPaymentMethod.length === 0 ? (
                  ...
                  <>
                    <BreakdownPieChart data={salesByPaymentMethod} />
                    <div className="space-y-2 mt-2 max-h-[100px] overflow-y-auto pr-1 custom-scrollbar">
