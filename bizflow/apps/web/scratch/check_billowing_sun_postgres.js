...
const connectionString = "postgresql://neondb_owner:npg_9joCySKxm0Hi@ep-tiny-scene-aj1nynbc.c-3.us-east-2.aws.neon.tech/postgres?sslmode=require";
...
async function main() {
  ...
  try {
    ...
    console.log("Connected to billowing-sun-78559264 'postgres' database successfully.");
